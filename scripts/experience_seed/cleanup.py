...
from scripts.experience_seed.shared import AIS_SNAPSHOT_ID, NODE_SNAPSHOT_IDS, ROUTE_SNAPSHOT_IDS
...
async def _clear_experience_rows(session) -> None:
    ...
    await _delete_route_codes(session, ["ROUTE_SUZHOU_NANJING_STEEL", "ROUTE_HUZHOU_WUHU_CEMENT"])
    await session.flush()
