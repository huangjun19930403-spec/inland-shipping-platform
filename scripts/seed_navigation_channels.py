...
The v7 seed is intentionally self-contained: it does not read revier.zip or any
long-running cleaning source. Running this script rebuilds the local navigation
channel tables and removes the legacy water_system tables.
"""
