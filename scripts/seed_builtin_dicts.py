...
BUILTIN_DICTS: list[dict[str, Any]] = [
    ...
    {"dict_code": "FREIGHT_BATCH_STATUS", "dict_name": "微信采集批次状态", "items": [_item("NEW", "待解析", color="info"), _item("PARSING", "解析中", color="warning"), _item("PARSED", "已解析", color="success"), _item("FAILED", "解析失败", color="danger"), _item("IGNORED", "已忽略", color="info")]},
    {"dict_code": "FREIGHT_TMS_INBOUND_STATUS", "dict_name": "TMS 入站状态", "items": [_item("NEW", "待解析", color="info"), _item("PARSING", "解析中", color="warning"), _item("PARSED", "已解析", color="success"), _item("FAILED", "解析失败", color="danger"), _item("IGNORED", "已忽略", color="info")]},
    ...
    {"dict_code": "AUDIT_OBJECT_TYPE", "dict_name": "审核对象类型", "items": [_item("TRANSPORT_NODE", "运输节点", color="primary"), _item("REGION", "业务区域", color="success"), _item("COMMODITY_STANDARD", "标准货品", color="warning"), _item("SHIP_PROFILE", "船舶主档", color="info"), _item("FREIGHT", "正式货源", color="danger")]},
