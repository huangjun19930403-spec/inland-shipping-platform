...
BUILTIN_DICTS: list[dict[str, Any]] = [
    ...
    {"dict_code": "VESSEL_PROFILE_STATUS", "dict_name": "船舶档案状态", "items": [_item("NEED_GOVERNANCE", "待治理", color="warning", is_default=True), _item("ACTIVE", "可用", color="success"), _item("INACTIVE", "停用", color="info"), _item("TRANSFERRED", "已转移", color="primary"), _item("ARCHIVED", "归档", color="info"), _item("DECOMMISSIONED", "退役", color="danger")]},
    ...
    {"dict_code": "VESSEL_QUALITY_LEVEL", "dict_name": "船舶质量等级", "items": [_item("HIGH", "高", color="success"), _item("MEDIUM", "中", color="warning"), _item("LOW", "低", color="danger", is_default=True)]},
    {"dict_code": "VESSEL_OPERATOR_ROLE", "dict_name": "船舶运营方角色", "items": _items(("OPERATOR", "运营方"), ("MANAGER", "管理方"), ("DISPATCH", "调度方"), ("AGENT", "代理方"))},
    {"dict_code": "VESSEL_OPERATOR_RISK_LEVEL", "dict_name": "船舶运营风险等级", "items": [_item("LOW", "低风险", color="success", is_default=True), _item("MEDIUM", "中风险", color="warning"), _item("HIGH", "高风险", color="danger"), _item("UNKNOWN", "未评估", color="info")]},
    ...
    {"dict_code": "VESSEL_QUALITY_ISSUE_TYPE", "dict_name": "船舶质量问题类型", "items": _items(("MISSING_SHIP_TYPE", "缺少船型"), ("MISSING_CAPACITY", "缺少载重/尺度"), ("MISSING_OWNER", "缺少所有人"), ("MISSING_OPERATOR", "缺少运营方"), ("MISSING_CONTACT", "缺少联系人"), ("MISSING_CERTIFICATE", "缺少证件"), ("DUPLICATE_MMSI", "MMSI 重复"), ("IDENTITY_CONFLICT", "身份冲突"))},
    {"dict_code": "VESSEL_QUALITY_ISSUE_STATUS", "dict_name": "船舶质量问题状态", "items": [_item("OPEN", "待处理", color="warning", is_default=True), _item("RESOLVED", "已解决", color="success"), _item("CLOSED", "已关闭", color="info"), _item("IGNORED", "已忽略", color="info")]},
    {"dict_code": "VESSEL_ISSUE_SEVERITY", "dict_name": "船舶问题严重级别", "items": [_item("HIGH", "高", color="danger"), _item("MEDIUM", "中", color="warning", is_default=True), _item("LOW", "低", color="info")]},
    {"dict_code": "VESSEL_IDENTITY_CANDIDATE_TYPE", "dict_name": "船舶身份候选类型", "items": _items(("SAME_MMSI", "相同 MMSI"), ("SAME_AIS", "相同 AIS"), ("SAME_NAME", "相同船名"), ("SAME_CERTIFICATE", "相同证件"), ("PARAMETER_CLOSE", "参数接近"))},
    {"dict_code": "VESSEL_IDENTITY_CANDIDATE_STATUS", "dict_name": "船舶身份候选状态", "items": [_item("PENDING", "待核对", color="warning", is_default=True), _item("CONFIRMED", "已确认", color="success"), _item("REJECTED", "已驳回", color="info")]},
    ...
    {"dict_code": "VESSEL_CHANGE_EVENT_TYPE", "dict_name": "船舶变更事件类型", "items": _items(("CREATE", "新增船舶档案"), ("UPDATE_PROFILE", "更新主档"), ("UPSERT_REGISTRATION", "维护登记信息"), ("UPSERT_CAPACITY", "维护容量尺度"), ("UPSERT_BUILD_INFO", "维护建造信息"), ("UPSERT_CARGO_CAPABILITY", "维护货运能力"), ("UPSERT_MANUAL_PREFERENCE", "维护接货偏好"), ("REPLACE_OWNERS", "维护所有人"), ("REPLACE_OPERATORS", "维护运营方"), ("REPLACE_CONTACTS", "维护联系人"), ("REPLACE_CREW", "维护船员任职"), ("REPLACE_PERSON_CERTIFICATES", "维护人员证书"), ("CREATE_CERTIFICATE", "新增证件"), ("UPDATE_CERTIFICATE", "更新证件"), ("UPLOAD_CERTIFICATE_FILE", "上传证件附件"), ("IMAGE_RECOGNIZE_CERTIFICATE", "识别证件图片"), ("IMAGE_RECOGNIZE_CERTIFICATE_FAILED", "证件图片识别失败"), ("CONFIRM_CERTIFICATE_IMAGE_RECOGNITION", "确认证件图片识别"), ("OWNER_TRANSFER_OUT", "所有人转移出"), ("OWNER_TRANSFER_IN", "所有人转移入"), ("REVIEW_IDENTITY_CANDIDATE", "审核身份候选"), ("SEED_CREATE", "样例生成"))},
