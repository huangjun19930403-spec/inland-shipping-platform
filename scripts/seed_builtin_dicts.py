...
BUILTIN_DICTS: list[dict[str, Any]] = [
    ...
    {"dict_code": "VESSEL_CHANGE_EVENT_TYPE", "dict_name": "船舶变更事件类型", "items": _items(("CREATE", "新增船舶档案"), ("UPDATE_PROFILE", "更新主档"), ("UPSERT_REGISTRATION", "维护登记信息"), ("UPSERT_CAPACITY", "维护容量尺度"), ("UPSERT_CARGO_CAPABILITY", "维护货运能力"), ("REPLACE_CONTACTS", "维护联系人"), ("CREATE_CERTIFICATE", "新增证件"), ("UPDATE_CERTIFICATE", "更新证件"), ("UPLOAD_CERTIFICATE_FILE", "上传证件附件"), ("OWNER_TRANSFER_OUT", "所有人转移出"), ("OWNER_TRANSFER_IN", "所有人转移入"), ("REVIEW_IDENTITY_CANDIDATE", "审核身份候选"), ("SEED_CREATE", "样例生成"))},
