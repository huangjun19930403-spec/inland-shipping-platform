...
MENUS = [
    ...
    {
        "menu_code": "FREIGHT_AI_PARSE_RECORDS",
        "menu_name": "AI 解析记录",
        "menu_type_code": "MENU",
        "parent_code": "FREIGHT_ROOT",
        "route_path": "/freight/ai/parse-records",
        "component_path": "modules/freight/pages/FreightAiParseRecordPage",
        "icon": "MagicStick",
        "sort_order": 3,
        "visible_flag": 1,
        "status_code": "ACTIVE",
    ...
    {
        "menu_code": "FREIGHT_SOURCE_INBOUNDS",
        "menu_name": "来源接入记录",
        "menu_type_code": "MENU",
        "parent_code": "FREIGHT_ROOT",
        "route_path": "/freight/source-inbounds",
        "component_path": "modules/freight/pages/FreightSourceInboundPage",
        "icon": "ChatLineRound",
        "sort_order": 5,
        "visible_flag": 1,
        "status_code": "ACTIVE",
...
SYSTEM_CONFIGS = [
    ...
    },
    {
        ...
        "last_test_message": None,
        "last_tested_at": None,
        "description": "货源解析默认模型，可通过环境变量覆盖。",
    },
    {
