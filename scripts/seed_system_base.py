...
SYSTEM_CONFIGS = [
    ...
    },
    {
        ...
        "last_test_message": None,
        "last_tested_at": None,
        "description": "货源解析强模型，默认用于低置信度候选复核。",
    },
    {
        "config_key": DASHSCOPE_FAST_MODEL,
        "config_name": "通义千问快模型",
        ...
        "last_test_message": None,
        "last_tested_at": None,
        "description": "货源解析快模型，默认用于 AI 线索切分和字段抽取。",
    },
    {
    ...
    {
        "config_key": DASHSCOPE_STRONG_REVIEW_ENABLED,
        "config_name": "启用强模型复核",
        "config_value": "true",
        "value_type_code": "BOOLEAN",
        "config_group_code": "AI",
        ...
        "last_test_message": None,
        "last_tested_at": None,
        "description": "低置信度或字段缺失候选是否交给强模型复核。",
    },
    {
