...
BUILTIN_DICTS: list[dict[str, Any]] = [
    ...
    {"dict_code": "ANALYSIS_SOURCE_LAYER", "dict_name": "分析来源层级", "items": [_item("VESSEL_PROFILE_SUMMARY", "船舶资产摘要", color="primary"), _item("AIS_SNAPSHOT", "AIS 快照", color="primary"), _item("AIS_LATEST_POSITION", "实时 AIS 最新船位", color="primary"), _item("SPATIAL_OBSERVATION", "空间观测快照", color="success"), _item("QUALITY_ISSUE", "质量问题", color="warning"), _item("RISK_SIGNAL", "风险信号", color="danger"), _item("CANDIDATE_ANALYSIS", "候选适配分析", color="info"), _item("PRODUCTION_ANALYSIS", "生产分析预计算", color="success"), _item("STANDARD_FREIGHT_SAMPLE", "标准货源样本", color="primary"), _item("TMS_PRODUCTION_FREIGHT", "TMS 生产货源", color="success"), _item("REGION_SUPPLY_DEMAND", "区域供需分层", color="info"), _item("LOCAL_DEMO", "本地演示", color="warning"), _item("TEST_FIXTURE", "测试夹具", color="info"), _item("LOCAL_SAMPLE", "本地样例", color="warning"), _item("NOT_AVAILABLE", "来源不可用", color="danger")]},
    {"dict_code": "ANALYSIS_NOT_COMPUTABLE_REASON", "dict_name": "分析不可计算原因", "items": [_item("SOURCE_MISSING", "来源缺失", color="warning"), _item("AIS_POSITION_SNAPSHOT_MISSING", "AIS 船位快照缺失", color="warning"), _item("COVERAGE_TOO_LOW", "覆盖率过低", color="warning"), _item("HISTORICAL_AIS_UNCONFIGURED", "历史 AIS 未配置", color="info"), _item("HISTORICAL_AIS_TRAJECTORY_SOURCE_MISSING", "历史 AIS 轨迹源缺失", color="info"), _item("EXTERNAL_RESULT_MISSING", "外部结果缺失", color="info"), _item("RISK_RULE_NOT_RUN", "风险规则未运行", color="warning"), _item("NO_ANALYSIS_SAMPLE", "无分析样本", color="info"), _item("NO_GOVERNANCE_SAMPLE", "暂无治理样本", color="info"), _item("DEMAND_LAYER_MISSING", "需求层缺失", color="warning"), _item("SUPPLY_LAYER_MISSING", "供给层缺失", color="warning"), _item("PROFILE_COVERAGE_GAP", "档案覆盖缺口", color="warning")]},
    {"dict_code": "ANALYSIS_DEMAND_LAYER", "dict_name": "分析需求层级", "items": [_item("FREIGHT_CLUE", "货源线索", color="info"), _item("TMS_PRODUCTION_FREIGHT", "TMS 生产货源", color="success", is_default=True), _item("STANDARD_FREIGHT_SAMPLE", "标准货源样本", color="primary"), _item("HISTORICAL_BUSINESS_SAMPLE", "历史业务样本", color="warning"), _item("EXTERNAL_TMS", "外部 TMS", color="success"), _item("NOT_AVAILABLE", "不可用", color="danger")]},
    {"dict_code": "ANALYSIS_SUPPLY_LAYER", "dict_name": "分析供给层级", "items": [_item("AIS_LATEST_POSITION", "实时 AIS 最新船位", color="primary", is_default=True), _item("AIS_SUPPLY_SAMPLE", "AIS 供给样本", color="primary"), _item("TRUSTED_PROFILE", "可信船舶档案", color="success"), _item("TRUSTED_PROFILE_SAMPLE", "可信档案样本", color="success"), _item("ACTIVE_VESSEL_SAMPLE", "活跃船舶样本", color="primary"), _item("LOW_RISK_SAMPLE", "低风险样本", color="success"), _item("NOT_AVAILABLE", "不可用", color="danger")]},
    {"dict_code": "VESSEL_DATA_SOURCE_TYPE", "dict_name": "船舶数据来源层", "items": _items(("GOVERNANCE_TASK", "治理任务"), ("VESSEL_PROFILE", "船舶主档"), ("VESSEL_SUMMARY", "船舶摘要"), ("VESSEL_SPATIAL_OBSERVATION", "空间观测"), ("VESSEL_NODE_OBSERVATION", "节点观测"), ("VESSEL_ROUTE_SEGMENT_OBSERVATION", "航线段观测"), ("RELATION_LEDGER", "关系账本"), ("CERTIFICATE_LEDGER", "证书账本"), ("QUALITY_ISSUE", "质量问题"), ("ES_REALTIME", "实时 AIS"), ("DEMO_ES_MIRROR", "演示 AIS 镜像"), ("LOCAL_DEMO", "本地演示"), ("TEST_FIXTURE", "测试夹具"), ("PROFILE_SUMMARY", "资产摘要"))},
    ...
    {"dict_code": "ROUTE_PLAN_TYPE", "dict_name": "运输方案类型", "items": _items(("STANDARD", "标准方案"), ("SEASONAL", "季节方案"), ("EMERGENCY", "应急方案"), ("MANUAL", "人工方案"), ("LOCAL_DEMO", "本地演示"), ("TEST_FIXTURE", "测试夹具"))},
    {"dict_code": "ROUTE_ENDPOINT_TYPE", "dict_name": "航线起讫对象类型", "items": _items(("REGION", "区域"), ("CITY", "城市"), ("NODE", "节点"))},
    {"dict_code": "ROUTE_PLAN_STATUS", "dict_name": "航线方案状态", "items": _items(("DRAFT", "草稿"), ("ACTIVE", "启用"), ("PAUSED", "停用"), ("ARCHIVED", "归档"))},
    {"dict_code": "ROUTE_PLAN_POINT_TYPE", "dict_name": "方案点位类型", "items": _items(("TRANSPORT_NODE", "运输节点"), ("CONSTRAINT_POINT", "通航约束点"), ("MANUAL_POINT", "手工点位"))},
    {"dict_code": "ROUTE_TRACK_STATUS", "dict_name": "航线轨迹状态", "items": _items(("NOT_GENERATED", "未生成"), ("READY", "已就绪"), ("PARTIAL", "部分生成"), ("FAILED", "生成失败"))},
    {"dict_code": "ROUTE_SEGMENT_RESULT_PROVIDER", "dict_name": "航段候选路径来源", "items": _items(("AMAP", "高德"), ("HIFLEET", "HiFleet"), ("MANUAL", "人工"), ("FALLBACK", "兜底轨迹"), ("AUTO", "自动选择"))},
    ...
    {"dict_code": "SOURCE_TYPE", "dict_name": "来源类型", "items": _items(("MANUAL", "人工录入"), ("IMPORT", "文件导入"), ("TMS", "TMS 接入"), ("HIGH_VALUE_INLAND", "高价值内河船舶档案"), ("TMS_HIGH_VALUE", "TMS 与高价值档案合并"), ("WECHAT", "微信语义解析"), ("SYSTEM", "系统生成"), ("LOCAL_DEMO", "本地演示"), ("TEST_FIXTURE", "测试夹具"), ("LOCAL_SAMPLE", "本地样例"), ("AI_RECOGNITION", "AI 识别"))},
