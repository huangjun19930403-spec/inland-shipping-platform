...
SEQUENCE_DEFINITIONS: list[dict[str, Any]] = [
    ...
    {
        "biz_code": "ROUTE_LINE_CODE",
        "biz_name": "航线路线编码",
        "target_table": "shipping_route_line",
        "target_column": "line_code",
        "prefix": "RL",
        "date_format": None,
        "separator": None,
        "current_value": 0,
    ...
    {
        "biz_code": "COMMODITY_CATEGORY_CODE",
        "biz_name": "货品分类编码",
        "target_table": "commodity_category",
        "target_column": "code",
        "prefix": "CC",
        "date_format": None,
        "separator": None,
    ...
    {
        "biz_code": "COMMODITY_TYPE_CODE",
        "biz_name": "货品类型编码",
        "target_table": "commodity_type",
        "target_column": "code",
        "prefix": "CT",
        "date_format": None,
        "separator": None,
    ...
    {
        "biz_code": "FREIGHT_INBOUND_NO",
        "biz_name": "货源接入记录号",
        "target_table": "freight_source_inbound",
    ...
    {
        "biz_code": "FREIGHT_PARSE_TASK_NO",
        "biz_name": "货源 AI 解析任务号",
        "target_table": "freight_ai_parse_task",
    ...
    {
        "biz_code": "SHIP_IMPORT_BATCH_NO",
        "biz_name": "船舶导入批次号",
        "target_table": "ship_import_batch",
