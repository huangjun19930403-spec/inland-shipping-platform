...
ANALYSIS_JOB_SPECS: list[AnalysisJobSpec] = [
    ...
    AnalysisJobSpec(
        ...
        ["vessel_profile", "vessel_capacity_dimension", "vessel_behavior_profile", "ES_HISTORY"],
    ...
    AnalysisJobSpec(
        ...
        ["freight", "vessel_profile", "vessel_capacity_dimension", "vessel_behavior_profile", "ES_HISTORY"],
        [
            "fact_freight_daily",
            "fact_freight_flow_daily",
            "fact_freight_commodity_daily",
