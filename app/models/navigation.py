...
class NavigationWaterArea(Base, TimestampMixin):
    ...
    center_lng: Mapped[float | None] = mapped_column(Numeric(11, 8), nullable=True)
    center_lat: Mapped[float | None] = mapped_column(Numeric(10, 8), nullable=True)
    shape_length_degree: Mapped[float | None] = mapped_column(Numeric(24, 15), nullable=True)
    shape_area_degree: Mapped[float | None] = mapped_column(Numeric(24, 15), nullable=True)
...
class NavigationRouteRequest(Base):
    ...
    destination_lng: Mapped[float] = mapped_column(Numeric(11, 8), nullable=False)
    destination_lat: Mapped[float] = mapped_column(Numeric(10, 8), nullable=False)
