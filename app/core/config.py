...
class Settings(BaseSettings):
    ...
    VESSEL_CITY_SITUATION_CACHE_TTL_SECONDS: int = 900
    VESSEL_CITY_SITUATION_SNAPSHOT_TTL_SECONDS: int = 1800
    VESSEL_CITY_SITUATION_PRECOMPUTE_SECONDS: int = 60
    VESSEL_CHANNEL_SITUATION_CACHE_TTL_SECONDS: int = 900
    VESSEL_CHANNEL_SITUATION_PRECOMPUTE_SECONDS: int = 60
    VESSEL_AIS_SITUATION_PRECOMPUTE_SECONDS: int = 300
    VESSEL_CHANNEL_SITUATION_NEAR_MATCH: bool = False
    VESSEL_SITUATION_PRECOMPUTE_ON_WORKER_START: bool = True
    VESSEL_SITUATION_PRECOMPUTE_DRILLDOWN_LIMIT: int = 100
    VESSEL_SITUATION_PRECOMPUTE_GROUP_LIMIT: int = 5
    VESSEL_CITY_SITUATION_PRECOMPUTE_GROUP_LIMIT: int = 5
    VESSEL_CHANNEL_SITUATION_PRECOMPUTE_GROUP_LIMIT: int = 0
    ANALYSIS_FLOW_ROUTE_CACHE_BACKEND: str = "redis"  # redis / memory(local only)
    ANALYSIS_FLOW_ROUTE_CACHE_TTL_SECONDS: int = 86400
    ANALYSIS_FLOW_ROUTE_FAILURE_CACHE_TTL_SECONDS: int = 300
    ANALYSIS_FLOW_ROUTE_PRECOMPUTE_ON_WORKER_START: bool = True
    ANALYSIS_FLOW_ROUTE_PRECOMPUTE_LIMIT: int = 20
    ANALYSIS_FLOW_ROUTE_PRECOMPUTE_SECONDS: int = 300
    ...
    VESSEL_AIS_PRECOMPUTE_PROFILE_PAGE_SIZE: int = 5000
    VESSEL_AIS_PRECOMPUTE_MAX_PROFILES: int = 0
    VESSEL_CANDIDATE_PRECOMPUTE_LIMIT: int = 20
    VESSEL_CANDIDATE_PRECOMPUTE_SECONDS: int = 1800
    ...
    HIFLEET_LOGOUT_URL: str = "/hifleetapi/generalUserLogoutAction.do"
